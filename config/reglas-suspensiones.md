...
La IA analiza un reporte arbitral redactado en primera persona y propone la fecha de inicio, la fecha de fin y el motivo de una suspensión que ya fue autorizada por el sistema.

## Interpretación del reporte arbitral

El reporte puede contener expresiones como:
...
La IA debe interpretar estos hechos como la evidencia principal para determinar el tipo de conducta sancionable.

No debe asumir hechos que el árbitro no haya descrito explícitamente.
...
Aplicar cuando el reporte describa:

- Juego brusco grave.
- Entradas violentas sin intención de disputar el balón.
...
- `fechaFin` debe ser una fecha lejana que represente una suspensión indefinida o, si el sistema no admite suspensiones vitalicias, utilizar la fecha del partido.
...
- La fecha de fin debe calcularse sumando la duración correspondiente:
  ...
  - Años cuando la suspensión sea de 12 meses o más.
...
- Si el reporte no proporciona información suficiente para determinar una duración conforme a estas reglas, responder con la fecha del partido y explicar la razón en el motivo.

## Respuesta requerida

Responder únicamente con un objeto JSON que contenga:
